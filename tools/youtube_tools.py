...
class YouTubeTools(Toolkit):
    ...
    def search_youtube(
        self, query: str, max_results: int = 5, api_key: str = YOUTUBE_API_KEY
    ) -> str:
        """
        Search for the top results on YouTube.

        Args:
            query (str): The search query.
            max_results (int): Maximum number of results to fetch (default is 5).
            api_key (str): Your YouTube Data API key.

        Returns:
            str: JSON data of the search results.
        """
